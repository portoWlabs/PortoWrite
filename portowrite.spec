...
a = Analysis(
    ...
    hiddenimports=[
        *pyside6_hiddenimports,
        ...
        'porto_write.ui.ebook_frame',
        'porto_write.ui.spell_highlighter',
        'porto_write.ui.project_mixin',
        'porto_write.ui.export_mixin',
        'porto_write.ui.preview_mixin',
        'porto_write.ui.style_mixin',
        'porto_write.ui.find_replace_mixin',
        'porto_write.ui.dialogs',
        'porto_write.ui.dialogs.editor',
        'porto_write.ui.dialogs.export',
        'porto_write.ui.dialogs.licence_key_dialog',
        'porto_write.ui.dialogs.metadata',
        'porto_write.ui.dialogs.project',
        'porto_write.ui.dialogs.settings',
        'porto_write.ui.dialogs.support',
        'porto_write.update_check',
        'porto_write.ui.update_dialog',
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
